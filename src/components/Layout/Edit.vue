    ...
    <q-card-section class="q-pt-none">
      ...
      <div class="row" v-for="lang in languages" :key="lang.locale">
        <div class="col-12 col-md-6 q-pr-md q-mt-md">
          ...
          <q-input
            v-model="banner.translations[lang.locale].name"
        ...
        <div class="col-12 col-md-6 q-pr-md q-mt-md">
          <label class="text-uppercase">{{ $t(lang?.locale) }}</label>
          <q-input
            v-model="banner.translations[lang.locale].description"
    ...
    <q-card-section class="q-pt-lg">
      <div class="row">
        <div v-for="lang in languages" :key="lang.locale" class="col-4 pr-3">
          ...
          <div v-if="!cropper[lang.locale]" class="box-2 img-result">
            <img
              style="width: 100%"
              class="cropped"
              :src="
          ...
          <div v-show="cropper[lang.locale]" class="page">
            <div class="box-2">
              <div
                style="height: 250px; width: 250px"
                :class="'result' + [lang?.locale]"
              ></div>
            </div>
          </div>
        </div>
...
const $q = useQuasar();
const { saving, update, getUsing } = useLayout();
...
async function onSubmit() {
  try {
    ...
    languages.value.forEach((lg, index) => {
      ...
      if (cropper.value[lg.locale] != undefined) {
        fomrData.append(`files[${lg.id}]`, cropper.value[lg.locale]);
      }
      if (banner.value.translations[lg.locale].name != "") {
        ...
        fomrData.append(
          ...
          banner.value.translations[lg.locale].name
        );
      }
      if (banner.value.translations[lg.locale].description != "") {
        ...
        fomrData.append(
          ...
          banner.value.translations[lg.locale].description
        );
      }
    });
