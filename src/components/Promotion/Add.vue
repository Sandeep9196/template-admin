        ...
        <div class="row">
          ...
          <!-- <div class="row"> -->
            ...
            >
              ...
              <q-input
                v-model="promotion.translation_name[lang.locale]"
                :label="$t(Utils.getKey('name'))"
                dense
                autogrow
                lazy-rules
...
async function onSubmit() {
  try {
    ...
    if (!validation) {
      document
        .getElementById("scrollIdPromotion")
    ...
    languages.value.forEach((lg, index) => {
      if (promotion.value.translation_name[lg.locale] == "") {
        allFill = true;
      }
    });
        ...
        languages.value.forEach((lg, index) => {
          if (promotion.value.translation_name[lg.locale] != "") {
            ...
            fomrData.append(
              ...
              promotion.value.translation_name[lg.locale]
            );
          }
        });
        try {
