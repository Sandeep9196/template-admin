      ...
      <q-form ref="refForm">
        <q-input
          ...
          :rules="[
            ...
            val =>  Utils.containsOnlyCharacterAllLanguage(val) || $t(Utils.getKey('only character')),
          ]"
        />
        <q-input
          :autofocus="true"
          ...
          :rules="[
            val => !!val || $t(Utils.getKey('Field is required')),
            val =>  Utils.containsOnlyCharacterExeptDash(val) || $t(Utils.getKey('only character')),
          ]"
        />
        <q-input
          :autofocus="true"
