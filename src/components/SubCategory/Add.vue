  ...
  >
    ...
    <q-card-section class="q-pt-lg">
      <q-form ref="refForm">
        ...
        <p class="text-bold mb-0 q-mb-md">
        ...
        <div class="row" v-for="lang in languages" :key="lang.locale">
          <div class="col-12 col-md-6 q-pr-md">
            ...
            <q-input
              v-model="subCategory.translation_name[lang.locale]"
              :label="$t(Utils.getKey('name'))"
              dense
              autogrow
              type="textarea"
          ...
          <div class="col-12 col-md-6 q-pr-md">
            <label class="text-uppercase">{{ $t(lang.locale) }}</label>
            <q-input
              v-model="subCategory.translation_desc[lang.locale]"
...
async function onSubmit() {
  try {
    ...
    languages.value.forEach((lg, index) => {
      if (
        subCategory.value.translation_name[lg.locale] == "" ||
        subCategory.value.translation_desc[lg.locale] == ""
      ) {
        allFill = true;
      }
    });
    ...
    cropper.value.getCroppedCanvas().toBlob(async (blob) => {
      ...
      languages.value.forEach((lg, index) => {
        if (subCategory.value.translation_name[lg.locale] != "") {
        ...
        if (subCategory.value.translation_desc[lg.locale] != "") {
          if (lg.id == 1) {
            fomrData.append(
              "description",
              subCategory.value.translation_desc[lg.locale]
