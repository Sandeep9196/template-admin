                ...
                <div class="row">
                  ...
                  >
                    <q-card flat class="mt-1">
                      <div>
                        <q-toggle v-model="isBoot" size="lg" icon="mdi-robot" />
                        <p class="text-bold">
...
const { saving, extendTime, updateIsBoot } = useDeals();
