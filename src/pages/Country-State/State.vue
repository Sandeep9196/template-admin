<template>
      ...
      >
        <template v-slot:top>
          <q-input
            ...
            :placeholder="$t(Utils.getKey('Search State Name'))"
            style="width: 300px"
          />
          <q-btn
  ...
  <q-dialog v-model="showAdd" position="top" persistent>
    <add-states @onClose="showAdd = false" :country="countries" :languages="languages" @onAdded="onRefresh" />
  </q-dialog>
...
import AddStates from "../../components/CountryStates/Add.vue";
import EditStates from "../../components/CountryStates/Edit.vue";
import Confirm from "../../components/Shared/Confirm.vue";
import useLanguage from "../../composables/useLanguage";

const { loading, columns, items, trash, paginate } = useCountryStates();
