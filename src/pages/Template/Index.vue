...
import EditTemplate from "../../components/Template/Edit.vue";
import AddTemplate from "../../components/Template/Add.vue";
import Confirm from "../../components/Shared/Confirm.vue";
import useLanguage from "src/composables/useLanguage";

const { all } = useLanguage();
const { loading, columns, items, trash, paginate } = useTemplate();
const {
  showAdd,
  showEdit,
  selected,
