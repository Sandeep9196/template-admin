<template>
  <q-page  :class="!store.leftDrawerOpen ? 'ml-5' : '' ">
    <q-card class="mt-3" style="margin-left: 0px; box-shadow: none; min-height: 100vh">
      <q-card-section>
        <q-table
          flat
          color="primary"
        ...
        >
          <template v-slot:top>
            ...
            <add-button
              v-if="Utils.hasPermissions(['Banner: Edit/Update Banner'])"
              :disable="loading"
              @click="showAdd = true"
              tooltip-text="Add"
              color="primary"
...
import EditBanner from "../../components/Banner/Edit.vue";
import Confirm from "../../components/Shared/Confirm.vue";
import useLanguage from "src/composables/useLanguage";
import AddBanner from "../../components/Banner/Add.vue";
const { all } = useLanguage();
const { loading, columns, items, trash, paginate } = useBanner();
const {
  showAdd,
  showEdit,
  selected,
